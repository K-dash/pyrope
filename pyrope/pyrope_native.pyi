# Internal stub file for pyrope_native extension module.
# This file is for internal use only. Public API types are defined in __init__.pyi.
...
# Internal operator factory functions (for pyrope.blueprint and pyrope.do)
